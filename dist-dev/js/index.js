...
var socket = _socket2.default.connect('http://' + host + ':8080');
...
var throttleFunc = (0, _throttle2.default)(function (event) {
  console.log('\n    acceleration x: ' + event.acceleration.x + '\n    acceleration y: ' + event.acceleration.y + '\n    acceleration z: ' + event.acceleration.z + '\n  ');
  var bgColor = accelToRGB(event.acceleration);
...
function accelToRGB() {
  var accel = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { x: 0, y: 0, z: 0 };
  ...
  var r = ('00' + Math.floor(R).toString(16)).slice(-2);
  var g = ('00' + Math.floor(G).toString(16)).slice(-2);
  var b = ('00' + Math.floor(B).toString(16)).slice(-2);
